...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/database_project/scripts/css/bootstrap.css" />
	<link rel="stylesheet" type="text/css" href="/database_project/scripts/css/coming-sssoon.css" />  
...
<div class="main" style="background-image: url('/database_project/scripts/images/default.jpg')">
...
<!--  H1 can have 2 designs: "logo" and "logo cursive"           -->
        ...
        <div class="content">
            <h4 class="motto">We are currently working on something awesome. Stay tuned!</h4>
            <div class="subscribe">
                <h5 class="info-text">
