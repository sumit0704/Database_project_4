...
import edu.tamu.ctv.service.defaultdata.InitChemicalsCreateService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception
	{
        ...
        .antMatchers("/Open/**","/users/**", "/scripts/**", "/", "/img/**").permitAll()		// Everything else pass?
    ...
    @Autowired
    @Bean
    public InitChemicalsCreateService initChemicalsCreateService(ChemicalsRepository chemicalsRepository) {
        return new InitChemicalsCreateService(chemicalsRepository);
    }
