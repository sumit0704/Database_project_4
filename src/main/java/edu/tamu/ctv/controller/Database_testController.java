...
@Controller
public class Database_testController {
	...
	private final Logger logger = LoggerFactory.getLogger(Database_testController.class);
	
	@RequestMapping(value = "/Open/Database_test", method = RequestMethod.GET)
